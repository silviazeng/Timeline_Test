var TL = (function (t) {
            ...
            return (function t() {
                ...
                var te = "http://www.w3.org/1998/Math/MathML",
                    ...
                    ue = function (t) {
                        ...
                        var n = _(t.nodeName);
                        if ((ce("uponSanitizeElement", t, { tagName: n, allowedTags: bt }), !he(t.firstElementChild) && (!he(t.content) || !he(t.content.firstElementChild)) && w(/<[/\w]/g, t.innerHTML) && w(/<[/\w]/g, t.textContent)))
                            return re(t), !0;
                        if (!bt[n] || Mt[n]) {
                            if (qt && !$t[n]) {
                                var r = it(t),
                        ...
                        return t instanceof h && !ne(t)
                            ...
                            ? (At && 3 === t.nodeType && ((e = t.textContent), (e = g(e, pt, " ")), (e = g(e, _t, " ")), t.textContent !== e && (p(i.removed, { element: t.cloneNode() }), (t.textContent = e))),
    ...
    function (t, e, i) {
        (function (t, n) {
             ...
             */ (function () {
                var a = "Expected a function",
                    ...
                    Ot = RegExp(
                        [
                            ...
                            Lt + "+(?:['â€™](?:D|LL|M|RE|S|T|VE))?(?=" + [_t, Mt + Et, "$"].join("|") + ")",
                            Mt + "?" + Et + "+(?:['â€™](?:d|ll|m|re|s|t|ve))?",
                ...
                var Ht = {};
                (Ht[l] = Ht[h] = Ht[k] = Ht[T] = Ht[c] = Ht[u] = Ht[M] = Ht[E] = Ht[L] = Ht[S] = Ht[D] = Ht[_] = Ht[m] = Ht[g] = Ht[v] = Ht[y] = Ht[w] = Ht[b] = Ht[A] = Ht["[object Uint8ClampedArray]"] = Ht[j] = Ht[C] = !0),
                    (Ht[d] = Ht[f] = Ht[x] = !1);
                var $t = { "\\": "\\", "'": "'", "\n": "n", "\r": "r", "\u2028": "u2028", "\u2029": "u2029" },
                    Bt = parseFloat,
                    Wt = parseInt,
                ...
                var Je = (function t(e) {
                    ...
                    function On(t, e, i, n) {
                        var r = n ? xe : be,
                            ...
                            o = e.length,
                            s = t;
                        for (t === e && (e = vr(e)), i && (s = fe(t, je(i))); ++a < o; ) for (var l = 0, h = e[a], c = i ? i(h) : h; (l = r(s, c, l, n)) > -1; ) s !== t && Yt.call(s, l, 1), Yt.call(t, l, 1);
                        return t;
                    }
                    function zn(t, e) {
                    ...
                    ((di && na(new di(new ArrayBuffer(1))) != T) || (fi && na(new fi()) != _) || (pi && "[object Promise]" != na(pi.resolve())) || (_i && na(new _i()) != y) || (mi && na(new mi()) != x)) &&
                        (na = function (t) {
                            var e = pn(t),
                    ...
                    return (
                        ...
                        (Si.split = function (t, e, i) {
                            return (
                                ...
                                (i = void 0 === i ? 4294967295 : i >>> 0) ? ((t = ls(t)) && ("string" == typeof e || (null != e && !Vo(e))) && !(e = Kn(e)) && Fe(t) ? cr(Ge(t), 0, i) : t.split(e, i)) : []
                            );
                        }),
                        ...
                        (Si.throttle = function (t, e, i) {
                            var n = !0,
                                r = !0;
                            if ("function" != typeof t) throw new gt(a);
                            return Wo(i) && ((n = "leading" in i ? !!i.leading : n), (r = "trailing" in i ? !!i.trailing : r)), bo(t, e, { leading: n, maxWait: e, trailing: r });
                        }),
                        (Si.thru = io),
                        (Si.toArray = is),
                        (Si.toPairs = Ss),
                        ...
                        (Si.prototype.reverse = function () {
                            ...
                            if (t instanceof Ci) {
                                var e = t;
                                return this.__actions__.length && (e = new Ci(this)), (e = e.reverse()).__actions__.push({ func: io, args: [Ba], thisArg: void 0 }), new ji(e, this.__chain__);
                            }
                            return this.thru(Ba);
                        }),
    ...
    function (t, e, i) {
        ...
        class ht {
            ...
            fire(t, e) {
                if (!this.hasEventListeners(t)) return this;
                for (var i = C({ type: t, target: this }, e), n = this._tl_events[t].slice(), r = 0, a = n.length; r < a; r++) n[r].action ? n[r].action.call(n[r].context || this, i) : O(`no action defined for ${t} listener`);
                return this;
            }
        }
        function ct(t, e) {
        ...
        class ft {
            constructor(t, e, i) {
                (this._el = { drag: t, move: t }),
                    ...
                    i && (this._el.move = i),
                    (this.options = { enable: { x: !0, y: !0 }, constraint: { top: !1, bottom: !1, left: !1, right: !1 }, momentum_multiplier: 2e3, duration: 1e3, ease: st }),
                    (this.animator = null),
                                  ...
                                  l &&
                                      ...
                                      a &&
                                          (c = function (e) {
                                              ...
                                              if (o && o !== r) return (n = t.extend(x(e), { currentTarget: o, liveFired: r })), (h || s).apply(o, [n].concat(i.call(arguments, 1)));
                                          }),
                                      _(r, e, s, o, a, c || h);
                              }));
                    }),
                ...
                (t.active = 0),
                    ...
                    (t.ajax = function (n) {
                        ...
                        if (
                            ...
                            (r.contentType || (!1 !== r.contentType && r.data && "GET" != r.type.toUpperCase())) && w("Content-Type", r.contentType || "application/x-www-form-urlencoded"),
                            r.headers)
                        )
        ...
        const Dt = [
            ...
            At = Mt.extend({
                initialize: function (t, e, i) {
                    Lt == t.constructor ? (this.data = { date_obj: t }) : ((this.data = JSON.parse(JSON.stringify(t))), this._createDateObj()), this._setFormat(e, i);
                },
                _createDateObj: function () {
                    var t = this._getDateData();
        ...
        function qt(t) {
            ...
            let o = r[0];
            if (((e.hour = parseInt(o)), i && "p" == i.toLowerCase()[0] && 12 != e.hour ? (e.hour += 12) : i && "a" == i.toLowerCase()[0] && 12 == e.hour && (e.hour = 0), isNaN(e.hour) || e.hour < 0 || e.hour > 23))
        ...
        class de {
            constructor(t, e, i) {
                i && this.setLanguage(i),
                    ...
                    C(this.options, e),
                    C(this.data, t),
                    this.options.background || ((this._el.container = T("div", "tl-media")), this.data.unique_id && (this._el.container.id = this.data.unique_id), this._initLayout());
            }
            loadMedia() {
                var t = this;
            ...
            updateMeta() {
                !this.data.credit &&
                    ...
                    ((this._el.credit = T("div", "tl-credit", this._el.content_container)), (this._el.credit.innerHTML = this.data.credit_alternate), (this.options.credit_height = this._el.credit.offsetHeight)),
                    !this.data.caption &&
                        this.data.caption_alternate &&
                        ((this._el.caption = T("div", "tl-caption", this._el.content_container)), (this._el.caption.innerHTML = this.data.caption_alternate), (this.options.caption_height = this._el.caption.offsetHeight)),
                    this.updateDisplay();
            }
            onAdd() {
                this.fire("added", this.data);
            ...
            load(t, e, i, n, r) {
                ...
                if (!this.pending[t] && (l = this.pending[t] = this.queue[t].shift())) {
                    for (a = 0, o = (h = l.urls).length; a < o; ++a)
                        (c = h[a]),
                            d ? (s = this.env.gecko ? this.createNode("style") : this.createNode("link", { href: c, rel: "stylesheet" })) : ((s = this.createNode("script", { src: c })).async = !1),
        ...
        class ge extends de {
            _loadMedia() {
                ...
                (this.youtube_loaded = !1),
                    ...
                    this.data.url.match("start=") ? (this.media_id.start = et(this.data.url.split("start=")[1])) : this.data.url.match("t=") && (this.media_id.start = et(this.data.url.split("t=")[1])),
        ...
        class Se extends de {
            _loadMedia() {
                ...
                (this._el.content_item = this.domCreate("div", "tl-media-item tl-media-documentcloud tl-media-shadow", this._el.content)),
                    (this._el.content_item.id = B(7)),
                    this.data.url.match(/\.html$/) ? (this.data.url = this._transformURL(this.data.url)) : this.data.url.match(/.(json|js)$/) || O("DOCUMENT CLOUD IN URL BUT INVALID SUFFIX"),
        ...
        class Oe extends de {
            ...
            _updateMediaDisplay(t) {
                ...
                (e = c ? this.options.height / 2 : this.options.height - this.options.credit_height - this.options.caption_height - 30),
                    ...
                    e > this.options.width ? (O("height is greater"), (i = this.options.width + 80 + "px"), (n = this.options.width + "px")) : (O("width is greater"), O(this.options.width), (i = e + "px"), (n = e - 80 + "px")),
        ...
        function $e(t, e) {
            var i = [
                ...
                { type: "profile", name: "Profile", match_str: /^(https?:)?\/*(www.)?instagr.am\/[a-zA-Z0-9]{2,}|^(https?:)?\/*(www.)?instagram.com\/[a-zA-Z0-9]{2,}/, cls: Ne },
        ...
        class Be {
            ...
            setHeight(t) {
                ...
                (this._el.content_container.style.height = t + "px"),
                    ...
                    t <= 56 ? L(this._el.content_container, "tl-timemarker-content-container-small") : S(this._el.content_container, "tl-timemarker-content-container-small"),
                    l
                        ? ((e = Math.floor(t / 14)) < 1 && (e = 1), (this._text.className = "tl-headline"), (this._text.style.webkitLineClamp = e))
                        : ((e = t / 12), (this._text.className = e > 1 ? "tl-headline tl-headline-fadeout" : "tl-headline"), (this._text.style.height = 12 * e + "px"));
            }
            setWidth(t) {
                this.data.end_date &&
                    ((this._el.container.style.width = t + "px"),
                    t > this.options.marker_width_min
                        ? ((this._el.content_container.style.width = t + "px"), (this._el.content_container.className = "tl-timemarker-content-container tl-timemarker-content-container-long"))
                        : ((this._el.content_container.style.width = this.options.marker_width_min + "px"), (this._el.content_container.className = "tl-timemarker-content-container")));
            }
            setClass(t) {
                this._el.container.className = t;
            }
        ...
        class We {
            constructor(t, e, i) {
                (this._el = { drag: t, move: t }),
                    ...
                    (this.touchdrag = { down: "touchstart", up: "touchend", leave: "mouseleave", move: "touchmove" }),
                    e && (this._el.move = e),
                    (this.options = { snap: !1, enable: { x: !0, y: !0 }, constraint: { top: !1, bottom: !1, left: 0, right: !1 }, momentum_multiplier: 2e3, duration: 1e3, ease: st }),
                    (this.animator = null),
                    (this.dragevent = this.mousedrag),
                    b && (this.dragevent = this.touchdrag),
                    (this.data = {
            ...
            _momentum() {
                ...
                (this.data.direction = null),
                    ...
                    n && this.data.direction
                        ...
                        : this.options.snap && (this.animator.stop(), (this.animator = ct(this._el.move, { top: this.data.pos.start.y, left: this.data.pos.start.x, duration: this.options.duration, easing: ot })));
            }
            _animateMomentum() {
                var t = { x: this.data.new_pos.x, y: this.data.new_pos.y },
                    e = { duration: this.options.duration, easing: ot };
        ...
        class Ue {
            ...
            _getTimeScale() {
                ...
                return (
                    ...
                    new se(this.config, { display_width: this._el.container.offsetWidth, screen_multiplier: this.options.scale_factor, max_rows: this.max_rows })
                );
            }
            _updateTimeScale(t) {
            ...
            goTo(t, e, i) {
                ...
                this._resetMarkersActive(),
                    ...
                    e
                        ...
                        : ((this._el.slider.className = "tl-timenav-slider"), (this.animator = ct(this._el.slider, { left: -this._markers[a].getLeft() + this.options.width / 2 + "px", duration: r, easing: n }))),
            ...
            _updateDrawTimeline(t) {
                var e = !1;
                if (t) {
                    var i = new se(this.config, { display_width: this._el.container.offsetWidth, screen_multiplier: this.options.scale_factor, max_rows: this.max_rows });
            ...
            _initLayout() {
                (this._el.attribution = T("div", "tl-attribution", this._el.container)),
                    ...
                    (this._swipable = new We(this._el.slider_background, this._el.slider, { enable: { x: !0, y: !1 }, constraint: { top: !1, bottom: !1, left: this.options.width / 2, right: !1 }, snap: !1 })),
        ...
        class Ze {
            ...
            show() {
                this.animator = ct(this._el.slider_container, { left: -this._el.container.offsetWidth * n + "px", duration: this.options.duration, easing: this.options.ease });
            }
            hide() {}
            setActive(t) {
            ...
            _initLayout() {
                ...
                this.data.media && this.data.media.url && "" != this.data.media.url && (this.has.media = !0),
                    ...
                    (this.has.text || this.has.headline) && ((this._text = new ue(this.data.text, { title: this.has.title, language: this.options.language, autolink: this.data.autolink })), this._text.addDateText(this.getFormattedDate())),
        ...
        class Ye {
            ...
            updateDisplay(t, e, i, n) {
                ...
                for (var o = 0; o < this._slides.length; o++) this._slides[o].updateDisplay(this.options.width, this.options.height, a), this._slides[o].setPosition({ left: this.slide_spacing * o, top: 0 });
            ...
            goTo(t, e, i) {
                ...
                t < this._slides.length &&
                    ...
                    e
                        ...
                        : (this.animator = ct(this._el.slider_container, { left: -this.slide_spacing * t + "px", duration: this.options.duration, easing: this.options.ease, complete: this._onSlideChange(i) })),
            ...
            _fireMouseEvent(t) {
                if (this._loaded) {
                    ...
                    (e = "mouseenter" === e ? "mouseover" : "mouseleave" === e ? "mouseout" : e),
                        this.hasEventListeners(e) && ("contextmenu" === e && _t.preventDefault(t), this.fire(e, { latlng: "something", layerPoint: "something else" }));
                }
            }
            _onLoaded() {
                this.fire("loaded", this.data);
            ...
            _initLayout() {
                this.message.removeFrom(this._el.container),
                    ...
                    "top" == this.options.timenav_position
                        ? ((this._el.timenav = T("div", "tl-timenav", this._el.container)), (this._el.storyslider = T("div", "tl-storyslider", this._el.container)))
                        : ((this._el.storyslider = T("div", "tl-storyslider", this._el.container)), (this._el.timenav = T("div", "tl-timenav", this._el.container))),
            ...
            _updateDisplay(t, e, i) {
                ...
                i && (r = i),
                    ...
                    e
                        ...
                        : ((this._el.timenav.style.height = Math.ceil(this.options.timenav_height) + "px"), (this._el.storyslider.style.height = this.options.storyslider_height + "px"), (this._el.menubar.style.top = o + "px")),
